...
export class UserController {
  ...
  @ApiOkResponse({ description: 'Daftar user' })
  ...
  @ApiOkResponse({ description: 'Daftar role' })
  @ApiStandardErrorResponses()
  ...
  @ApiOkResponse({ description: 'User dibuat' })
  @ApiStandardErrorResponses()
  async create(
  ...
  @ApiOkResponse({ description: 'User diupdate' })
  @ApiStandardErrorResponses()
  async update(
    @Req() req: FastifyRequest & { user?: JwtPayload },
  ...
  @ApiOkResponse({ description: 'Akun dibuka' })
  @ApiStandardErrorResponses()
  async unlock(
    @Req() req: FastifyRequest & { user?: JwtPayload },
    @Body() dto: UserUidDto,
  ...
  @ApiOkResponse({ description: 'Email reset dikirim (jika user valid)' })
  @ApiStandardErrorResponses()
  ...
  @ApiOkResponse({ description: 'User di-soft-delete' })
  @ApiStandardErrorResponses()
  async remove(
    @Req() req: FastifyRequest & { user?: JwtPayload },
