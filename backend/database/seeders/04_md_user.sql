...
INSERT INTO template."md_user" ("uid_user_system", "nama", "username", "password", "kd_role", "status_user", "is_deleted", "created_at", "updated_at", "email", "failed_login_attempts", "is_locked", "password_changed_at") VALUES
...
INSERT INTO template.d_password_history (uid_user_system, password_hash, created_at)
SELECT '00000000-0000-0000-0000-000000000001',
       '543a114a20358409b5b274bc05da3d06c0df7e5c00a0935ee1ae90dc9fc3ca75',
       NOW()
WHERE NOT EXISTS (
    SELECT 1 FROM template.d_password_history
